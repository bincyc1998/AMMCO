...
if(bypass == HIGH){
    ...
    if(i0 == LOW && i1 == HIGH && i2 == HIGH && i3 == LOW && i4 == HIGH && i5 == HIGH){
    ...
    else if (i0 == LOW && i1 == HIGH && i2 == HIGH && i3 == HIGH && i4 == LOW && i5 == LOW){
    ...
    else if (i0 == HIGH && i1 == LOW && i2 == HIGH && i3 == HIGH && i4 == LOW && i5 == HIGH){
        Serial.println("Center right cabin case 1 ");
        digitalWrite(Q0_0, LOW);
        digitalWrite(Q0_1, HIGH);
        digitalWrite(Q0_2, HIGH);
        digitalWrite(Q0_3, HIGH);
    }
    else if (i0 == HIGH && i1 == LOW && i2 == HIGH && i3 == HIGH && i4 == LOW && i5 == LOW){
        Serial.println("Center right cabin case 2");
        digitalWrite(Q0_0, LOW);
        digitalWrite(Q0_1, HIGH);
        digitalWrite(Q0_2, HIGH);
        digitalWrite(Q0_3, HIGH);
